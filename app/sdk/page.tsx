...
const S: Record<string, CSSProperties> = {
  ...
  ctitle: { fontSize: 18, fontWeight: 700, margin: "0 0 12px", display: "flex", alignItems: "center", gap: 8 },
  ...
  mono: { fontFamily: "ui-monospace, monospace", wordBreak: "break-all", textAlign: "right" },
      ...
      <div style={S.wrap}>
        ...
        <section style={S.hero}>
          ...
          <p style={S.p}>
            ...
            prove an outcome is <em>true</em>, and gives no on-chain way to challenge a bad
            signer. Built naively, every market keeps an admin key that can call{" "}
            <code>resolve()</code> — one leaked key and the market is drained or rigged.
          </p>
          <p style={S.p}>
        ...
        <section style={S.card}>
          <h2 style={S.ctitle}>⛓️ Programs (Solana {CLUSTER})</h2>
