...
export default function CommandPalette() {
  ...
  const cmds = useMemo<Cmd[]>(() => {
    ...
    return [
      ...
      { id: "app", label: pick(lang, { en: "Open the app", ru: "Открыть приложение", es: "Abrir la app", pt: "Abrir o app", fr: "Ouvrir l'app", de: "App öffnen", zh: "打开应用" }), group: gActions, keywords: "app dashboard launch", run: () => { setOpen(false); window.location.href = "/nyx/index.html"; } },
