...
export default function CommandPalette() {
  ...
  const cmds = useMemo<Cmd[]>(() => {
    ...
    return [
      { id: "bet", label: pick(lang, { en: "Place a bet", ru: "Сделать ставку", es: "Hacer una apuesta", pt: "Fazer uma aposta", fr: "Placer un pari", de: "Wette platzieren", zh: "下注" }), group: gActions, hint: "Blink", keywords: "bet stake wager blink solana", run: ext(BLINK_URL) },
