...
const CARDS = [
  ...
  },
  {
    ...
    desc: { en: "Qwen3-4B runs in Tether QVAC; every prediction ships an ed25519 receipt on Solana Memo.", ru: "Qwen3-4B работает в Tether QVAC; каждый прогноз сопровождается ed25519-квитанцией в Solana Memo.", es: "Qwen3-4B se ejecuta en Tether QVAC; cada predicción incluye un recibo ed25519 en Solana Memo.", pt: "Qwen3-4B roda no Tether QVAC; cada previsão inclui um recibo ed25519 no Solana Memo.", fr: "Qwen3-4B tourne dans Tether QVAC ; chaque prédiction fournit un reçu ed25519 dans un Solana Memo.", de: "Qwen3-4B läuft in Tether QVAC; jede Vorhersage liefert eine ed25519-Quittung im Solana Memo.", zh: "Qwen3-4B 在 Tether QVAC 中运行；每次预测都会在 Solana Memo 上附带一份 ed25519 回执。" },
  },
  {
    icon: Coins,
    tint: "text-payout",
